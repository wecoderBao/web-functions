...
<section class="sidebar">
	...
	<div class="user-panel">
		<div class="pull-left image">
			<img src="assets/admin/img/avatar3.png" class="img-circle"
				alt="User Image" />
		</div>
	...
	<ul class="sidebar-menu" id="leftNavigate">
		...
		<c:forEach items="${userLeftModules}" var="ModuleAndCategory">
			<li class="treeview"><a href="#"> <i class="fa fa-dashboard"></i>
					<span>${ModuleAndCategory.category.moduleCategoryName}</span> <i
					class="fa fa-angle-left pull-right"></i>
			</a>
				<ul class="treeview-menu">
					<c:forEach var="module" items="${ModuleAndCategory.moduleList}">
						<c:if test="${module.ifShow}">
							<li><a id="${module.moduleName}" href="${module.moduleUrl}"><i
									class="fa fa-circle-o"></i> ${module.moduleTitle}</a></li>
						</c:if>
					</c:forEach>
				</ul></li>
		</c:forEach>
