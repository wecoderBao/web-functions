...
//        url = "admin/prize_user_extra_chance/delete_relate/"+${oneJavaField}+"/"+id;
//    }else{
//        url = "admin/prize_user_extra_chance/add_relate/"+${oneJavaField}+"/"+id;
//    }
...
function  getItemPage(pageIndex){
    ...
    var url ='admin/prize_user_extra_chance/page_relate/'+pageIndex+'/'+pageCount;
